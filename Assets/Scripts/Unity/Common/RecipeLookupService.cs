...
/// <summary>
/// 레시피 검색 전담 서비스 (Singleton)
/// - 도구 + 재료 조합으로 레시피 검색 (SearchRecipeUsecase)
/// - 미니게임ID ↔ 도구ID 매핑
/// </summary>
public class RecipeLookupService : SingletonMonoBehaviour<RecipeLookupService>, SearchRecipeUsecase
{
